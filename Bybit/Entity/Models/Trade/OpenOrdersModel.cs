...
{
    public class OpenOrdersModel : BybitBaseModel, IBybitModel
    {
        [JsonPropertyName("result")]
        public OpenOrdersData? Result { get; set; }
    }

    public partial class OpenOrdersData
    {
        ...
        public List<OpenOrdersDataList>? OpenOrdersDataList { get; set; }
    }

    public partial class OpenOrdersDataList
    {
        ...
        public long TriggerDirection { get; set; }
